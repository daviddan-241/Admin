...
import { Menu, X, Instagram, Twitter, Music2, Sun, Moon } from "lucide-react";
            ...
            {navLinks.map((l) => (
              <Link
                ...
                className={`block px-3 py-2.5 rounded-xl text-sm font-medium transition-colors
                  ${location === l.href ? "text-foreground bg-foreground/8" : "text-muted-foreground hover:text-foreground hover:bg-foreground/5"}`}
              >
                {l.label}
              </Link>
            ))}
      ...
      <footer className="py-14 border-t border-border/40 bg-card/20 mt-auto">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-10 mb-10">
            <div>
              <h2 className="font-serif text-2xl font-bold text-foreground mb-3">Hannah Brooks</h2>
            ...
            <div>
              <h4 className="text-foreground font-semibold mb-4 text-xs uppercase tracking-widest">Follow Hannah</h4>
